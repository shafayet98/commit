!function(e, t) {
    ...
    function r() {
        ...
        return g.prototype = b, i(S, "constructor", {
            value: b,
            configurable: !0
        }), i(b, "constructor", {
            value: g,
    ...
    function D(e, t) {
        ...
        if (null != e) {
            if ("object" !== o(e) && (e = [
                e
            ]), j(e)) for(r = 0, n = e.length; r < n; r++)t.call(null, e[r], r, e);
            else {
    ...
    var I = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global, q = function(e) {
        return !R(e) && e !== I;
    };
    ...
    }), Object.defineProperties(Y, ee), Object.defineProperty(Z, "isAxiosError", {
        value: !0
    ...
    function ie(e, t, r) {
        ...
        })).metaTokens, i = r.visitor || f, a = r.dots, s = r.indexes, u = (r.Blob || "undefined" != typeof Blob && Blob) && Q.isSpecCompliantForm(t);
        ...
        function c(e) {
            ...
            return Q.isArrayBuffer(e) || Q.isTypedArray(e) ? u && "function" == typeof Blob ? new Blob([
                e
            ]) : Buffer.from(e) : e;
        }
        function f(e, r, i) {
            ...
            if (e && !i && "object" === o(e)) {
                if (Q.endsWith(r, "{}")) r = n ? r : r.slice(0, -2), e = JSON.stringify(e);
                    ...
                    !Q.isUndefined(e) && null !== e && t.append(!0 === s ? ne([
                        r
                    ], n, a) : null === s ? r : r + "[]", c(e));
                }), !1;
            }
        ...
        return function e(r, n) {
            if (!Q.isUndefined(r)) {
                ...
                l.push(r), Q.forEach(r, function(r, o) {
                    !0 === (!(Q.isUndefined(r) || null === r) && i.call(t, r, Q.isString(o) ? o.trim() : o, n, h)) && e(r, n ? n.concat(o) : [
                        o
                    ]);
                }), l.pop();
            }
    ...
    }, ye = "undefined" != typeof window && "undefined" != typeof document, ve = (le = "undefined" != typeof navigator && navigator.product, ye && [
        "ReactNative",
        "NativeScript",
        "NS"
    ].indexOf(le) < 0), me = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" == typeof self.importScripts, ge = t(t({}, Object.freeze({
        __proto__: null,
        hasBrowserEnv: ye,
    ...
    function be(e) {
        function t(e, r, n, o) {
            ...
            return i = !i && Q.isArray(n) ? n.length : i, s ? (Q.hasOwnProp(n, i) ? n[i] = [
                n[i],
                r
            ] : n[i] = r, !a) : (n[i] && Q.isObject(n[i]) || (n[i] = []), t(e, r, n[i], o) && Q.isArray(n[i]) && (n[i] = function(e) {
    ...
    var we = {
        ...
        transformResponse: [
            function(e) {
                var t = this.transitional || we.transitional, r = t && t.forcedJSONParsing, n = "json" === this.responseType;
        ...
        return u(r, [
            {
                ...
                value: function(e, t, r) {
                    ...
                    return Q.isPlainObject(e) || e instanceof this.constructor ? f(e, t) : Q.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim()) ? f((c = {}, (i = e) && i.split("\n").forEach(function(e) {
                        u = e.indexOf(":"), a = e.substring(0, u).trim().toLowerCase(), s = e.substring(u + 1).trim(), !a || c[a] && Oe[a] || ("set-cookie" === a ? c[a] ? c[a].push(s) : c[a] = [
                            s
                        ] : c[a] = c[a] ? c[a] + ", " + s : s);
    ...
    var Ue = {
        ...
        xhr: "undefined" != typeof XMLHttpRequest && function(e) {
            return new Promise(function(t, r) {
                ...
                if (Q.isFormData(a)) {
                    if (ge.hasStandardBrowserEnv || ge.hasStandardBrowserWebWorkerEnv) s.setContentType(!1);
                ...
                function j() {
                    if (w) {
                        ...
                        !function(e, t, r) {
                            ...
                            r.status && n && !n(r.status) ? t(new Y("Request failed with status code " + r.status, [
                                Y.ERR_BAD_REQUEST,
                                Y.ERR_BAD_RESPONSE
                ...
                if (w.open(e.method.toUpperCase(), fe(S, e.params, e.paramsSerializer), !0), w.timeout = e.timeout, "onloadend" in w ? w.onloadend = j : w.onreadystatechange = function() {
                    ...
                    var t = e.timeout ? "timeout of " + e.timeout + "ms exceeded" : "timeout exceeded", n = e.transitional || pe;
    ...
    function ze(e) {
        return qe(e), e.headers = xe.from(e.headers), e.data = Pe.call(e, e.transformRequest), -1 !== [
            "post",
            "put",
            "patch"
        ].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), Ie(e.adapter || Ee.adapter)(e).then(function(t) {
    ...
    var Ke = {
        ...
        function e(t) {
            a(this, e), this.defaults = t, this.interceptors = {
                request: new he,
                response: new he
            };
        }
